...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { end_time: @auction.end_time, item_id: @auction.item_id, minimum_bid: @auction.minimum_bid, start_time: @auction.start_time } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { end_time: @auction.end_time, item_id: @auction.item_id, minimum_bid: @auction.minimum_bid, start_time: @auction.start_time } }
